	...
	return (
		<Container>
			<ThreeStatsCarousel>
				...
				<ThreeStatsContainer xwidth={slideIndex}>
					<CardContainer
						animate={animate}
						ref={cardRef}
							...
							{relations === null ? (
								...
								<>
									<RelationsItem>
										...
										{relations &&
										relations.double_damage_from.length >
											1 ? (
											<RelationsItemType>
									...
									<RelationsItem>
										...
										{relations &&
										relations.double_damage_to.length >
											1 ? (
											<RelationsItemType>
									...
									<RelationsItem>
										...
										{relations &&
										relations?.half_damage_from.length >
											1 ? (
											<RelationsItemType>
												{' '}
